...
pkg_resources.ContextualVersionConflict: (ec2-utils 0.22 (/home/pasi/src/ec2-utils), Requirement.parse(\'ec2-utils==0.21\'), {\'nameless-deploy-tools\'})
...
pkg_resources.DistributionNotFound: The \'ec2-utils==0.21\' distribution was not found and is required by nameless-deploy-tools
```
